...
export default function VorteX({ show }) {
    return (
        <>
            {
                show ?
                    <Vortex
                        ...
                        colors={['#2196F3', '#607d8b', '#355C7D', '#6C5B7B', '#C06C84']}
                    />
                    :
                    <svg
                        height={150}
                        ...
                        aria-label="vortex-loading"
                        className="vortex-wrapper"
                        aria-busy="true"
                        role="status"
                    >
                            ...
                            <g transform="scale(0.7)">
                                <g transform="translate(-50,-50)">
                                    <g transform="rotate(137.831 50 50)">
                                        ...
                                        />
                                        <path d="M94.7,53.2C89,41.4,80,31.1,68.1,23.7c-0.9-0.3-1.9-0.5-2.8-0.8c3.8,3.8,7.2,8.1,10,13 c2.6,4.4,4.5,9.1,5.9,13.8c0.3,0.9,0.5,1.9,0.7,2.8c2.4,9.9,2.2,20.2-0.4,29.8C89.4,74.5,94,64,94.7,53.2z" />
                                    </g>
                                </g>
                            </g>
                        </g>
